...
class Decoder(nn.Module):
    def __init__(self, input_nc, output_nc, ngf=64,
        ...
        Decoder_5 = UnetSkipConnectionDBlock(ngf * 2, output_nc, norm_layer=norm_layer, use_dropout=use_dropout, outermost=True)
    ...
    def forward(self, input_1, input_2, input_3, input_4, input_5):
        y_1 = self.Decoder_1(input_5)
        y_2 = self.Decoder_2(torch.cat([y_1, input_4], 1))
        y_3 = self.Decoder_3(torch.cat([y_2, input_3], 1))
        y_4 = self.Decoder_4(torch.cat([y_3, input_2], 1))
        y_5 = self.Decoder_5(torch.cat([y_4, input_1], 1))
        out = y_5
